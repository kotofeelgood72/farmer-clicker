...
export const ACHIEVEMENT_DEFINITIONS: AchievementDefinition[] = [
  ...
  { id: 'c4', category: 'chat', rarity: 'rare', name: 'Ночной чатер', desc: 'Написать ночью (22:00–06:00)' },
  ...
  { id: 'p6', category: 'progress', rarity: 'epic', name: 'VIP игрок', desc: 'Купить премиум' },
  ...
  { id: 'sw1', category: 'swipes', rarity: 'common', name: 'Первый match', desc: 'Получить первый мэтч' },
